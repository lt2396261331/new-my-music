...
__DEFINE__(1678168149976, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1678168149977,"./event-store":1678168149978}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1678168149977, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1678168149978, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1678168149977,"./utils":1678168149979}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1678168149979, function(require, module, exports) {
...
return __REQUIRE__(1678168149976);
})()
